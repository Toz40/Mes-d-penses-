...
function openExpenseDetails(id){
 ...
 setTimeout(()=>{document.getElementById('cancelModal').onclick=()=>document.getElementById('modal').close();document.getElementById('detailEditExpense').onclick=()=>{document.getElementById('modal').close();openExpense('',e.id)}},0)
}
